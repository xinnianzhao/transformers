...
from .tokenization_whisper_wa import TASK_IDS, TO_LANGUAGE_CODE
...
class WhisperWAGenerationMixin:
        ...
        **kwargs,
        ...
        if is_shortform:
            ...
            if prompt_ids is not None:
                # batch generation for fixed prompt
                if prompt_ids.shape[0] == decoder_input_ids.shape[0]:
                    decoder_input_ids = torch.cat([prompt_ids, decoder_input_ids], dim=-1)
                else:
